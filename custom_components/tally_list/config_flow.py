    ...
    async def async_step_free_marks(self, user_input=None):
        ...
        if user_input is not None:
            ...
            if enable:
                ...
                self.hass.data.setdefault(DOMAIN, {})[CONF_ENABLE_FREE_MARKS] = True
                self.hass.data[DOMAIN][CONF_CASH_USER_NAME] = name
            ...
            if self._enable_free_marks:
                ...
                if confirmation in {"JA ICH WILL", "YES I WANT"}:
                    ...
                    self.hass.data.setdefault(DOMAIN, {})[CONF_ENABLE_FREE_MARKS] = False
