...
- Services to add, remove, adjust, reset and export tallies, and set the public PIN.
...
- Public devices can tally drinks for everyone when a user-defined PIN is provided.
...
- `tally_list.set_pin`: set or clear the PIN required for public devices.
